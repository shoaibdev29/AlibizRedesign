...
--
-- Host: localhost:8889
-- Generation Time: May 07, 2025 at 04:01 AM
...
(115, '2025_04_19_165218_create_user_accounts_table', 55),
(116, '2025_04_20_113838_create_wallet_transactions_table', 55),
(117, '2025_04_20_131432_add_bring_change_amount_column_to_orders_table', 55),
(118, '2025_04_20_134052_add_paid_amount_column_to_orders_table', 55),
(119, '2025_04_28_115248_add_transaction_id_column_to_wallet_transactions_table', 55);
...
CREATE TABLE `user_accounts` (
  ...
  `wallet_balance` decimal(24,8) NOT NULL DEFAULT '0.00000000',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `wallet_transactions` (
  `id` bigint UNSIGNED NOT NULL,
  `walletable_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `walletable_id` bigint UNSIGNED NOT NULL,
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `transaction_id` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `direction` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `amount` decimal(24,8) NOT NULL,
  `opening_balance` decimal(24,8) NOT NULL,
...
ALTER TABLE `user_accounts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_accounts_accountable_type_accountable_id_index` (`accountable_type`,`accountable_id`);
...
ALTER TABLE `wallet_transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `wallet_transactions_walletable_type_walletable_id_index` (`walletable_type`,`walletable_id`);
