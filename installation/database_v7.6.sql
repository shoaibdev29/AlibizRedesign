...
--
-- Host: localhost:3306
-- Generation Time: Jan 05, 2025 at 08:00 AM
...
('b8992bd4-d6a0-11ed-962c-0c7a158e4469', 'paymob_accept', '{\"gateway\":\"paymob_accept\",\"mode\":\"live\",\"status\":\"0\",\"public_key\":\"\",\"secret_key\":\"\",\"integration_id\":\"\",\"hmac\":\"\"}', '{\"gateway\":\"paymob_accept\",\"mode\":\"test\",\"status\":\"0\",\"public_key\":\"\",\"secret_key\":\"\",\"integration_id\":\"\",\"hmac\":\"\"}', 'payment_config', 'test', 0, NULL, '2025-01-04 14:59:15', NULL),
...
CREATE TABLE `banners` (
  ...
  `banner_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'primary'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(6, 'mail_config', '{\"status\":0,\"name\":\"Delivery APP\",\"host\":\"mail.demo.com\",\"driver\":\"smtp\",\"port\":\"587\",\"username\":\"info@demo.com\",\"email_id\":\"info@demo.com\",\"encryption\":\"tls\",\"password\":\"demo\"}', NULL, '2025-01-04 14:59:15'),
...
(69, 'push_notification_service_file_content', '', NULL, NULL),
(70, 'maintenance_system_setup', '[]', NULL, NULL),
(71, 'maintenance_duration_setup', '{\"maintenance_duration\":\"until_change\",\"start_date\":null,\"end_date\":null}', NULL, NULL),
(72, 'maintenance_message_setup', '{\"business_number\":1,\"business_email\":1,\"maintenance_message\":\"We are Cooking Up Something Special!\",\"message_body\":\"Our system is currently undergoing maintenance to bring you an even tastier experience. Hang tight while we make the dishes.\"}', NULL, NULL),
(73, 'firebase_otp_verification', '{\"status\":0,\"web_api_key\":\"\"}', NULL, NULL),
(74, 'google_map_status', '1', NULL, NULL),
(75, 'apple_login', '{\"status\":0, \"login_medium\":\"apple\",\"client_id\":\"\",\"client_secret\":\"\",\"team_id\":\"\",\"key_id\":\"\",\"service_file\":\"\",\"redirect_url\":\"\"}', NULL, NULL);
...
(1, 1, 'fixed', 0, 0, 0, 100, '2024-09-28 18:22:11', '2024-09-28 18:22:11');
...
(1, 'email_verification', '0', '2024-09-28 18:22:11', '2024-09-28 18:22:11'),
(2, 'phone_verification', '0', '2024-09-28 18:22:11', '2024-09-28 18:22:11'),
(3, 'login_options', '{\"manual_login\":1,\"otp_login\":0,\"social_media_login\":0}', '2024-09-28 18:22:11', '2024-09-28 18:22:11'),
(4, 'social_media_for_login', '{\"google\":0,\"facebook\":0,\"apple\":0}', '2024-09-28 18:22:11', '2024-09-28 18:22:11');
...
(107, '2024_09_10_105232_change_transaction_reference_column_length_in_orders_table', 54),
(108, '2024_09_10_150352_create_login_setups_table', 54),
(109, '2024_09_15_124747_create_delivery_charge_setups_table', 54),
(110, '2024_09_15_125514_create_delivery_charge_by_areas_table', 54),
(111, '2024_09_18_123359_create_guest_users_table', 54),
(112, '2024_09_18_124800_add_guest_id_in_orders_table', 54),
(113, '2024_09_18_124921_add_guest_id_in_customer_addresses_table', 54),
(114, '2024_09_21_154530_create_order_areas_table', 54);
