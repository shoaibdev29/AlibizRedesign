...
use App\Models\BranchAttribute; // Changed model to branch-specific
...
class BranchAttributeController extends Controller
{
    public function __construct(
        private BranchAttribute $attribute,
    ...
    function index(Request $request): View|Factory|Application
    {
        ...
        $attributes = $attributes->orderBy('name')->paginate(Helpers::getPagination())->appends($queryParam);
        return view('branch-views.attribute.index', compact('attributes', 'search'));
    }
    ...
    {
        $request->validate([
            'name' => 'required|unique:branch_attributes',
        ]);
        ...
        foreach($request->lang as $index => $key)
        {
            ...
            {
                $data[] = [
                    'translationable_type' => BranchAttribute::class,
    ...
    public function edit($id): View|Factory|Application
    {
        ...
        return view('branch-views.attribute.edit', compact('attribute'));
    }
