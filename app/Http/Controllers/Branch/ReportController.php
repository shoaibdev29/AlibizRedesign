...
class ReportController extends Controller
{
    ...
    public function orderIndex(): Factory|View|Application
    {
        ...
        return view('branch-views.report.order-index');
    }
    ...
    public function earningIndex(): Factory|View|Application
    {
        ...
        return view('branch-views.report.earning-index');
    }
    ...
    public function driverReport(Request $request): Factory|View|Application
    {
        ...
        return view('branch-views.report.deliveryman-report-index', compact('deliverymen','orders', 'deliverymanId', 'startDate', 'endDate'));
    }
    ...
    public function productReport(Request $request): Factory|View|Application
    {
        ...
        return view('branch-views.report.product-report', compact('data', 'totalSold', 'totalQuantity', 'branches', 'products', 'startDate', 'endDate', 'branchId', 'productId'));
    }
    ...
    public function saleReport(Request $request): Factory|View|Application
    {
        ...
        return view('branch-views.report.sale-report', compact('orders', 'data', 'totalSold', 'totalQuantity', 'startDate', 'endDate', 'branchId', 'branches'));
    }
    ...
    public function walletTransactionHistory(Request $request): Factory|View|Application
    {
        ...
        return view('branch-views.report.wallet-transaction-history', compact('walletTransactions', 'users'));
