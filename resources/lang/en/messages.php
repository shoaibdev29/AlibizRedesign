<?php return array (
  ...
  'Branch Flash Sale' => 'Branch Flash Sale',
  'Flash' => 'Flash',
  'flash' => 'Flash',
  'Add New Banner' => 'Add New Banner',
  'Banner type' => 'Banner type',
  'Image format: jpg, png, jpeg | Maximum Size: 2 MB' => 'Image format: jpg  png  jpeg | Maximum Size: 2 MB',
  'No data' => 'No data',
  'Update Banner' => 'Update Banner',
  ...
  'primary' => 'Primary',
  'Recommended image ratio is' => 'Recommended image ratio is',
  'Processing' => 'Processing',
  'Please upload a banner image' => 'Please upload a banner image',
  'Want to delete this banner?' => 'Want to delete this banner ',
  'Banner Management' => 'Banner Management',
  'Error' => 'Error',
  'File size exceeds 2MB limit' => 'File size exceeds 2MB limit',
  'Invalid file type. Allowed: JPG, PNG, GIF, BMP, TIFF' => 'Invalid file type. Allowed: JPG  PNG  GIF  BMP  TIFF',
  'File too large. Maximum size: 2MB' => 'File too large. Maximum size: 2MB',
  'Updating' => 'Updating',
  'You want to change the status' => 'You want to change the status',
  'You want to change the status?' => 'You want to change the status ',
  'category image' => 'Category image',
  'Click to upload' => 'Click to upload',
  'Image format: jpg, png, jpeg | Max: 2MB' => 'Image format: jpg  png  jpeg | Max: 2MB',
  'Failed to send notification!' => 'Failed to send notification!',
  'New coupon code generated' => 'New coupon code generated',
  'Failed to load coupon details' => 'Failed to load coupon details',
  'Image format: jpg, png, jpeg, webp | Maximum Size: 2MB' => 'Image format: jpg  png  jpeg  webp | Maximum Size: 2MB',
  'Primary Image' => 'Primary Image',
  'Secondary Image' => 'Secondary Image',
  'Select a conversation to view messages' => 'Select a conversation to view messages',
  'Failed to load conversation' => 'Failed to load conversation',
  'Failed to send message' => 'Failed to send message',
  'Type your message...' => 'Type your message...',
  'Attach' => 'Attach',
  'Send' => 'Send',
  'color_variant_images' => 'Color variant images',
  'upload_images_for_each_color_variant' => 'Upload images for each color variant',
  'select_colors' => 'Select colors',
  'Select color' => 'Select color',
  'add_more_colors' => 'Add more colors',
