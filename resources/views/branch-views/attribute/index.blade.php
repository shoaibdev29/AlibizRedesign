...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('branch.attribute.store')}}" method="post">
                    @csrf
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a class="btn btn-outline-info square-btn"
                                        href="{{route('branch.attribute.edit',[$attribute['id']])}}"><i class="tio tio-edit"></i></a>
                                ...
                                <form action="{{route('branch.attribute.delete',[$attribute['id']])}}"
...
<script>
    ...
    // Beautiful delete confirmation like admin
