                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-border-lg avatar-uploader profile-cover-avatar" for="avatarUploader">
                            <img id="viewer" class="avatar-img"
                                src="{{auth('branch')->user()->image_fullpath}}"  alt="{{ translate('image') }}">
    ...
    <script>
        ...
        $('#saveChangesButton').click(function() {
            if ('{{ env('APP_MODE') }}' === 'demo') {
                ...
                form_alert('branch-settings-form', '{{ translate("Want to update the branch information ?") }}');
            }
        });
