    ...
    <div class="border px-3 py-2 rounded mb-3">
        <div class="media gap-3">
            <div class="avatar rounded-circle">
                <img class="img-fit rounded-circle" src="{{$user['image_fullpath']}}" alt="{{ translate('image') }}">
            </div>
            <div class="mb-0">
                    ...
                    <div class="col-12">
                        <div class="received_msg">
                            @if($con->message)
                                ...
                                <span class="time_date">{{$con->created_at->format('Y-m-d h:i A')}}</span>
                            @endif
                            @if($con->attachment)
                                <div class="row">
    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <input type="file" name="images[]" multiple accept="image/*" style="display: none" id="file-input">
                    <button type="button" class="btn btn-secondary btn-sm"
                        onclick="document.getElementById('file-input').click()">
                        <i class="tio-upload"></i> {{translate('Attach')}}
                    </button>
                </div>
                <button type="button" onclick="replyConvs('{{route('branch.message.store', [$user->id])}}')"
