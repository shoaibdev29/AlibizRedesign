                ...
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                    ...
                    @foreach($customers as $key=>$customer)
                        <tr>
                            ...
                            <td>
                                <a class="text-dark media gap-3 align-items-center" href="{{route('branch.customer.view',[$customer['id']])}}">
                            ...
                            <td>
                                <label class="badge badge-soft-info">
                                    {{$customer->orders()->where('branch_id', auth('branch')->user()->id)->count()}}
                                </label>
                            </td>
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a class="btn btn-outline-primary btn-sm square-btn" href="{{route('branch.customer.view',[$customer['id']])}}">
