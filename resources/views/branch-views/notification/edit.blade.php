...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('branch.notification.update', [$notification['id']])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <div class="col-lg-6">
                                    ...
                                    <div class="upload-file">
                                        ...
                                        <div class="upload-file__img">
                                            <img width="150" id="viewer"
                                                 src="{{$notification['image_url']}}" alt="{{ translate('notification') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
