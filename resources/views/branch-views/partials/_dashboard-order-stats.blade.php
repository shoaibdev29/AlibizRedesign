...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats" href="{{route('branch.orders.list',['canceled'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{asset('assets/admin/img/icons/cancel.png')}}" class="order-stats__img" alt="{{ translate('canceled') }}">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats" href="{{route('branch.orders.list',['failed'])}}">
        <div class="order-stats__content">
            <img width="20" src="{{asset('assets/admin/img/icons/failed_to_deliver.png')}}" class="order-stats__img" alt="{{translate('failed_to_delivered')}}">
