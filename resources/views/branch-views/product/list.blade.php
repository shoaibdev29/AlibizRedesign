                                    ...
                                    <td>
                                        <div class="media gap-3 align-items-center">
                                            <div class="avatar rounded border">
                                             ...
                                             <a href="{{route('branch.product.view',[$product['id']])}}" class="media-body text-dark">
                                        ...
                                        @if($product['status']==1)
                                            <label class="switcher">
                                                <input type="checkbox" class="switcher_input change-status" checked id="{{$product['id']}}"
                                                       data-route="{{route('branch.product.status',[$product['id'],0])}}">
                                                <span class="switcher_control"></span>
                                            </label>
                                        @else
                                            <label class="switcher">
                                                <input type="checkbox" class="switcher_input change-status"  id="{{$product['id']}}"
                                                       data-route="{{route('branch.product.status',[$product['id'],1])}}">
                                                <span class="switcher_control"></span>
                                            </label>
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 justify-content-center">
                                            <a class="btn btn-outline-primary square-btn"
                                                href="{{route('branch.product.edit',[$product['id']])}}">
                                        ...
                                        <form action="{{route('branch.product.delete',[$product['id']])}}"
...
<script>
    ...
    // Optional: Toastr success notifications
