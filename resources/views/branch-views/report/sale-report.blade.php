                ...
                <form action="#" id="form-data" method="GET">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3 __btn-row d-flex gap-2">
                            <a href="{{ route('branch.report.sale-report') }}"
                        ...
                        <div class="col-6 pt-4">
                            <div class="hs-unfold mr-5 float-right">
                                <a class="js-hs-unfold-invoker btn btn-sm btn-white"
                                   href="{{route('branch.report.export-sale-report', ['branch_id'=>Request::get('branch_id'), 'start_date'=>Request::get('start_date'), 'end_date'=>Request::get('end_date')])}}">
