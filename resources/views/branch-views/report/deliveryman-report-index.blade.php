            ...
            <div class="card-body">
                <form action="#" id="form-data" method="GET">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="mb-3">
                                <input type="date" name="start_date" id="from_date" value="{{ $startDate }}"
                                    class="form-control">
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="col-sm-6 col-xl-3 mb-3 __btn-row d-flex gap-2">
                            <a href="{{ route('branch.report.driver-report') }}"
                                class="btn btn-secondary flex-fill">{{ translate('clear') }}</a>
                            <button type="submit" class="btn btn-primary flex-fill">{{ translate('show') }}</button>
                        </div>
                                ...
                                <td>
                                    @if($order->customer)
                                        <a class="text-body text-capitalize"
                                            href="{{route('branch.customer.view', [$order['user_id']])}}">{{$order->customer['f_name'] . ' ' . $order->customer['l_name']}}</a>
                                    @else
                                        <label class="badge badge-danger">{{translate('invalid')}} {{translate('customer')}}
