    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{asset('public/assets/admin/img/icons/earning_report.png')}}"
                    alt="{{ translate('earning-report') }}">
                ...
                <div class="media-body">
                    <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-between gap-3">
                        <div class="text-capitalize">
                            <h2 class="page-header-title">{{translate('earning')}} {{translate('report')}}
                        ...
                        <div class="col-12">
                            <div class="mb-2">
                                <label for="exampleInputEmail1"
                                    class="form-label">{{translate('show_data_by_data_range')}}</label>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <span class="font-size-sm text-success">
                                            ...
                                            {{ Helpers::set_symbol(round(abs($totalSold - $totalTax))) }}
                                        </span>
                                    </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
                @php
                    $yearlySold = \App\Models\Order::where(['order_status' => 'delivered'])->whereBetween('created_at', [date('y-01-01'), date('y-12-31')])->sum('order_amount')
                @endphp
                <h6 class="card-subtitle mb-0">{{translate('Total sale of')}} {{date('Y')}} :<span class="h3 ml-sm-2">
                        {{ Helpers::set_symbol($yearlySold) }}</span>
                </h6>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            function generateHoursData() {
                ...
                while (dt <= end) {
                    data.push({ x: dt.format('YYYY-MM-DD'), y: dt.format('e'), d: dt.format('YYYY-MM-DD'), v: Math.random() * 24 });
                    dt = dt.add(1, 'day');
                }
                return data;
            }
            ...
            $.HSCore.components.HSChartMatrixJS.init($('.js-chart-matrix'), {
                data: {
                    datasets: [{
                        ...
                        width: function (ctx) { let a = ctx.chart.chartArea; return (a.right - a.left) / 70; },
                        height: function (ctx) { let a = ctx.chart.chartArea; return (a.bottom - a.top) / 10; }
                    }]
                },
                options: {
                    tooltips: {
                        callbacks: {
                            ...
                            label: function (item, data) {
                                ...
                                return v.v.toFixed() > 0 ? '<span class="font-weight-bold">' + v.v.toFixed() + ' hours</span> on ' + v.d : '<span class="font-weight-bold">No time</span> on ' + v.d;
                            }
                        }
                    },
                    scales: {
                        xAxes: [{ position: 'bottom', type: 'time', offset: true, time: { unit: 'week', round: 'week', displayFormats: { week: 'MMM' } }, ticks: { "labelOffset": 20, "maxRotation": 0, "minRotation": 0, "fontSize": 12, "fontColor": "rgba(22, 52, 90, 0.5)", "maxTicksLimit": 12 }, gridLines: { display: false } }],
                        yAxes: [{ type: 'time', offset: true, time: { unit: 'day', parser: 'e', displayFormats: { day: 'ddd' } }, ticks: { "fontSize": 12, "fontColor": "rgba(22, 52, 90, 0.5)", "maxTicksLimit": 2 }, gridLines: { display: false } }]
                    }
                }
            });
