    ...
    <form action="{{route('branch.pos.order')}}" id='order_place' method="post">
        ...
        <div class="collect-cash-section pb-80 pb-sm-3" style="display: block">
            <div class="form-group mb-2 d-flex align-items-center justify-content-between gap-2">
                ...
                <input type="number" class="form-control w-50 text-right" name="show_paid_amount" step="0.01" id="showPaidAmount" value="{{ round($total+$total_tax, 2) }}"
                       required="">
                <input type="hidden" class="hidden-paid-amount" name="paid_amount" id="paidAmount" value="{{ round($total+$total_tax, 2) }}">
                <input type="hidden" class="hidden-paid-amount" id="totalAmount" value="{{ round($total+$total_tax, 2) }}">
            </div>
        ...
        <div class="pos-cart-bottom-btns bg-white shadow">
            <div class="row g-2">
                ...
                <div class="col-sm-6">
                    <button type="submit" class="btn  btn-primary btn-block" id="placeOrder"><i class="fa fa-shopping-bag"></i>
