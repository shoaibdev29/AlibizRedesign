    ...
    <div class="content container-fluid">
        <div class="mb-3">
            <h2 class="text-capitalize mb-0 d-flex align-items-center gap-2">
                <img width="20" src="{{asset('assets/admin/img/icons/product-review.png')}}" alt="{{ translate('product-review') }}">
                        ...
                        <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                            ...
                            @foreach($reviews as $key=>$review)
                                    <tr>
                                        ...
                                        <td>
                                             @if($review->product)
                                                <a class="text-dark" href="{{route('branch.product.view',[$review['product_id']])}}">
                                                    {{ $review->product['name'] }}
                                                </a>
                                            @else
                                        ...
                                        <td>
                                            @if(isset($review->customer))
                                                <a class="text-dark" href="{{route('branch.customer.view',[$review->user_id])}}">
